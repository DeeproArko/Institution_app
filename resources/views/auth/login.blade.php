        ...
        <div class="card">
          <div class="card-body">
            ...
            @csrf
             ...
             <button type="submit" style="background: green; padding: 10px 40px; border: none; border-radius: 5px; cursor: pointer">Login</button>
             </div>
            </form>
            <div class="text-center mt-3">
              <p>Don't have an account? <a style="color: blue" href="{{ route('register') }}">Please Register</a></p>
            </div>
          </div>
        </div>
      </div>
